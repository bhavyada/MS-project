...
#define MAX_LOCK_NEST 8					/* Maximum nesting for Locks */
...
struct thread
  {
    ...
    int recent_cpu;						/* recent cpu calculater for this thread- fixed point */
...
uint64_t thread_get_sleepUntil(void);
void thread_set_sleepUntil(uint64_t);
